...
import {GET_CABANG, GET_SUPLIER} from '../../../api/apiRoutes';
import {API_STATES} from '../../../utils/constant';

const CabangWorkplanDropdown = ({onChange, value}) => {
...
export default CabangWorkplanDropdown;
